var Turn = function(config) {
    ...
    self.arm_offset         = config.extra.rotation_offset || 0;
    self.arm_range          = 45;
    self.arm_anchor_offset  = [config.extra.x_offset || 0, config.extra.y_offset || 0];
    self.arm_width          = config.extra.width || 32;
    self.arm_height         = config.extra.height || 7;
    self.arm_image          = config.extra.svg_url || '/media/arms/svg/small_arm_2.svg';

    self.extra = main_svg.image(self.arm_image);
