...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      initOpacity: 1,
      imgPath: '/site_media/static/widgets/editor/images/',
      extPath: '/site_media/static/widgets/editor/extensions/',
      jGraduatePath: '/site_media/static/widgets/editor/lib/jgraduate/images/',
      extensions: [],
      initTool: 'select',
      wireframe: false,
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
      ...
      setTimeout(function() {
        svgCanvas.embedImage('/site_media/static/widgets/editor/images/placeholder.svg', function(datauri) {
          if(!datauri) {
            // Disable option
