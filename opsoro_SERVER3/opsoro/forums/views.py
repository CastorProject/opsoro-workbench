...
from .models import (Forum, ForumCategory, ForumReply, ForumThread,
                     ThreadSubscription, UserPostCount)
...
def reply_create(request, thread_id):
    ...
    return render(request, "reply_create.html", {
        "form": form,
        # "member": member,
        "thread": thread,
        "subscribed": thread.subscribed(request.user, "email"),
...
def subscribe(request, thread_id):
    ...
    if request.method == "POST":
        ...
        return render(request, "subscribe.html", {"thread": thread})
...
def unsubscribe(request, thread_id):
    ...
    if request.method == "POST":
        ...
        return render(request, "unsubscribe.html", {"thread": thread})
...
def thread_updates(request):
    ...
    return render("thread_updates.html", {"subscriptions": subscriptions})
